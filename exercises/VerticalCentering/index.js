...
const VerticalCentering = () => {
  return (
    <div>
      <div className="flex items-center pa3 bg-red white mb4 center VerticalCentering__container">
      ...
      <div className="flex items-center justify-center bg-red white relative vh-50">
